...
let makeVideoBtn = document.getElementById('makeVideoButton');
...
let rMinSlider = document.getElementById("RedMinSlider");
let gMinSlider = document.getElementById("GreenMinSlider");
let bMinSlider = document.getElementById("BlueMinSlider");
let rMaxSlider = document.getElementById("RedMaxSlider");
let gMaxSlider = document.getElementById("GreenMaxSlider");
let bMaxSlider = document.getElementById("BlueMaxSlider");
